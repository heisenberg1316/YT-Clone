...
const HomeVideosSectionSkeleton = () => {
    return (
        <div className="gap-4 gap-y-10  pt-11  grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 [@media(min-width:1920px)]:grid-cols-4">
            {
...
const HomeVideosSectionSuspense = ({categoryId} : HomeVideosSectionProps) => {
    ...
    return (
        <div>
            <div className="gap-4.5 pt-11 gap-y-10 grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 [@media(min-width:1920px)]:grid-cols-4">
                {
