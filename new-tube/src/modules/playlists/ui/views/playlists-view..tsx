...
export const PlaylistsView = () => {
    ...
    return (
        <div className="max-w-[2400px] mx-auto mb-10 px-6 pt-2.5 flex flex-col gap-y-6">
            ...
            <div className="flex justify-between items-center">
                ...
                <Button variant="outline" size="icon" className="rounded-full cursor-pointer" onClick={() => setCreateModalOpen(true)}>
                    <PlusIcon />
                </Button>
            </div>
            <PlaylistsSection />
