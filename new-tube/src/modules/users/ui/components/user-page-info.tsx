    ...
    return (
        <div className="py-6">
            ...
            <div className="hidden md:flex items-start gap-4">
                ...
                <div className="flex-1 min-w-0">
                    <Skeleton className="h-[40px] w-[200px]" />
                    <Skeleton className="h-[20px] w-[100px] mt-4" />
                    <Skeleton className="h-[20px] w-[100px] mt-5" />
                </div>
            </div>
        </div>
    );
        ...
        <div className="py-6">
            ...
            <div className="flex flex-col space-y-4 md:hidden">
                ...
                <Button
                    ...
                    asChild
                >
                    <Link prefetch prefetch href="/studio">
                    Go to studio
                    </Link>
                </Button>
                ) : (
            ...
            <div className="hidden md:flex items-start gap-4">
                ...
                { userId === user.clerkId ? (
                    ...
                    <SubscriptionButton
                    className="mt-3 rounded-full cursor-pointer"
                    onClick={onClick}
                    disabled={isPending || !isLoaded}
                    isSubscribed={user.viewerSubscribed}
                    />
